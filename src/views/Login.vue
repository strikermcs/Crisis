<template>
    ...
    <div class="input-field">
      ...
      class="helper-text invalid">Введите коректный email</small>
    ...
    <div class="input-field">
      ...
      class="helper-text invalid">Пароль должен содержать {{$v.password.$params.minLength.min}} или больше символов.
